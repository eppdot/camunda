...
/**
 * Regression tests that rely on the COMBINED input-mapping mode being the engine default.
 *
 * <p>These tests will FAIL if the default is reverted to ORDERED, which is the intended signal: the
 * scenarios below require COMBINED's context-literal sibling scoping to pass.
 *
 * @see <a href="https://github.com/camunda/camunda/issues/60551">#60551</a>
 */
public final class ActivityInputMappingCombinedTest {

  // No withEngineConfig — uses the engine default, which must be COMBINED for these tests to pass.
  ...
  public void shouldResolveBareSiblingReferenceInNestedContextWithCombinedDefault() {
    ...
    // `type` resolves to the sibling value "gihub" written by mapping 1. With ORDERED, `type` is
            ...
            Bpmn.createExecutableProcess(processId)
                ...
                .subProcess(
                    ...
                    b -> {
                      ...
                      b.zeebeInputExpression("=\"gihub\"", "authentication.type")
    ...
    assertThat(
        ...
        .containsExactly(variable("authentication", "{\"type\":\"gihub\",\"final\":\"gihub\"}"));
  }
}
